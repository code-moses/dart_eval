...
Pair<List<Variable>, Map<String, Variable>> compileArgumentListWithDynamic(
  ...
  for (var i = 0; i < argumentList.arguments.length; i++) {
    ...
    if (!arg0.type.isAssignableTo(ctx, CoreTypes.function.ref(ctx))) {
      // The callee is unknown at compile time; both interpreted methods and
      // builtin/bridge wrappers expect boxed arguments over a dynamic
      // dispatch boundary.
      arg0 = arg0.boxIfNeeded(ctx);
    }
